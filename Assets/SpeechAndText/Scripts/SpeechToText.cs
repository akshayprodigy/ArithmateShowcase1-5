...
//#endif
        ...
        public void StartRecording(string _message = "")
        {
            ...
            //        }
            //#endif
            Debug.Log("StartRecording: "+ _message);
            ...
            */
            ...
            object[] setParameter = new object[1];
            setParameter[0] = unityActivity;
            toSpeech.Call("activateMicroPhone", setParameter);
        }
        public void StopRecording()
        {
            ...
            */
            ...
            object[] setParameter = new object[1];
            setParameter[0] = unityActivity;
            toSpeech.Call("OnStopRecording", setParameter);
        }
        ...
        {
            Debug.Log("onResults unity: " + _results);
        ...
        {
            Debug.Log("onEndOfSpeech: " + _paramsNull);
        ...
        {
            Debug.Log("onBeginningOfSpeech: " + _paramsNull);
        ...
        {
            Debug.Log("onPartialResults: " + _params);
