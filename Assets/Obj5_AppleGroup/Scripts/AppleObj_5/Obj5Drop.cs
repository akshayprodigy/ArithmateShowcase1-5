...
using UnityEngine; //public AppleManager AppleManager;
using UnityEngine.EventSystems;
using UnityEngine.UI;

public class Obj5Drop : MonoBehaviour, IDropHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        if (GameObject.Find("GameManager").GetComponent<GameManager>().isObj5_AppleGroup)
        {
            ...
            if (dropSprite != null)
            {
                ...
                if ((originalObj.name == "Frac" && containerImage.name == "Frac"))
                {
                    ...
                    receivingImage.sprite = currentData.GetComponent<Image>().sprite;
                ...
                else if ((originalObj.name == "AppleInTray" && containerImage.name == "Tray1"))
                {
                    ...
                    receivingImage.tag = currentData.tag;
                    receivingImage.sprite = currentData.GetComponent<Image>().sprite;
                ...
                else if ((originalObj.name == "AppleInTray" && containerImage.name == "Full"))
                {
                    receivingImage = GameObject.FindGameObjectWithTag("coin").transform.GetComponent<Image>();

                    //receivingImage = currentData.GetComponent<Image>();
                    receivingImage.tag = currentData.tag; 
                    Color c = receivingImage.color;
                    c.a = 1;
                    receivingImage.color = c;
    ...
    void changeTag()
    {
        ...
        {
            currentData.transform.gameObject.tag = "coin";
            //currentData.gameObject.GetComponent<Obj5Drag>().enabled = false;
            Color c = currentData.transform.gameObject.GetComponent<Image>().color;
            c.a = 0;
            currentData.transform.gameObject.GetComponent<Image>().color = c;
           
            Debug.Log("done full"+ currentData.tag);
        }


        currentData.gameObject.GetComponent<Obj5Drag>().enabled = false;
        receivingImage.gameObject.GetComponent<Obj5Drag>().enabled = true;
        //foreach (GameObject t1a1 in GameObject.FindGameObjectsWithTag("Red"))
        //    t1a1.GetComponent<Obj5Drag>().enabled = true;
        //foreach (GameObject t2a2 in GameObject.FindGameObjectsWithTag("Green"))
        //    t2a2.GetComponent<Obj5Drag>().enabled = true;
        //foreach (GameObject t3a3 in GameObject.FindGameObjectsWithTag("Yellow"))
        //    t3a3.GetComponent<Obj5Drag>().enabled = true;
    }
    void rem()
    {
        changeTag();
    ...
    private Sprite GetDropSprite(PointerEventData data)
    {
        ...
        var dragMe = originalObj.GetComponent<Obj5Drag>();
        if (dragMe == null)
            return null;
